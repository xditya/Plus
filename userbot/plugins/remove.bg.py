...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.edit("Removed dat annoying BackGround in {} seconds, powered by @xtratgplus".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @xtratgplus\n`{}".format(output_file_name.content.decode("UTF-8")))
