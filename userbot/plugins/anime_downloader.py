"""
Anime Batch Downloader Plugin for userbot. //set TEMP_DOWNLOAD_DIRECTORY Env Var first.
...
@borg.on(admin_cmd(pattern="anid"))
async def anime_download(event):
	...
	if Config.TEMP_DOWNLOAD_DIRECTORY is None:
		...
		return
	download_dir=Config.TEMP_DOWNLOAD_DIRECTORY	
	try:
