...
class Config(object):
    ...
    HU_STRING_SESSION = os.environ.get("STRING_SESSION", None)
    ...
    GOOGLE_CHROME_DRIVER = os.environ.get("CHROME_DRIVER", None)
    GOOGLE_CHROME_BIN = os.environ.get("CHROME_BIN", None)
    # spotify stuff
    ...
    TIME_ZONE = os.environ.get("TZ", None)
